...
function init() {
    ...
    document.getElementsByTagName('body')[0].style.cursor = `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10 10"><circle fill="${color}" cx="10" cy="10" r="10"/></svg>'), auto`
...
function screenshot() { 
    ...
    let region = document.querySelector("body"); // cria uma variavel região do Body
