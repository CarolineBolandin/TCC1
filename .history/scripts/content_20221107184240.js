...
const cursorRounded = htmlToElement('<div id="cursor" style="flex: 1; width: 30px; height: 30px; border: 2px solid #fff; border-radius: 50%"> </div>');
document.getElementsByTagName('body') [0].appendChild(cursorRounded);


function init() {
    cursorRounded = htmlToElement('<div style="position: absolute;"></div>');
    document.getElementsByTagName('body')[0].appendChild(cursorRounded);
