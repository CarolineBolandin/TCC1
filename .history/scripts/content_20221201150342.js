...
function init() {
    ...
    document.getElementsByTagName('body')[0].style.cursor = `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><circle style="border: solid 1px, border-color: black" fill="${color}" cx="10" cy="10" r="10"/></svg>'), auto`
